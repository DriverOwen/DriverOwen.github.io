var thisRef = this;
var ModelFlag=0;
var ModelMsgBoxColor=["#adafca","#FC84B5","#ACB924","#A57550"];
...
function initL2dCanvas(canvasId)
{
    ...
    if(this.canvas.addEventListener) {
        this.canvas.addEventListener("mousewheel", mouseEvent, {passive:false});
...
function mouseEvent(e)
{
    ...
    // } 
        ...
        $(".live2d-info-text").css({
            "background":ModelMsgBoxColor[ModelFlag]
        },1000);
       
        console.log(ModelMsgBoxColor[ModelFlag]);
        changeModel();
    }
